...
public:
	...
	using Print::write;
        ...
        uint32_t baud(void) { return *(uint32_t *)usb_cdc_line_rtsdtr; }
        uint8_t stopbits(void) { return usb_cdc_line_coding[4]; }
        uint8_t paritytype(void) { return usb_cdc_line_coding[5]; }
        uint8_t numbits(void) { return usb_cdc_line_coding[6]; }
